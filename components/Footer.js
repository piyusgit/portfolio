...
const Footer = ({ isDarkTheme }) => {
  const socialLinks = [
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/in/piyush-kumar",
      icon: (
    ...
    {
      name: "GitHub",
      href: "https://github.com/piyusgit",
      icon: (
        <path
          fillRule="evenodd"
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="text-center md:text-left">
            ...
            <div className="flex items-center gap-2 text-gray-600 dark:text-gray-300">
              <Image
                src={isDarkTheme ? darkMailIcon : mailIcon}
                alt="Email"
                className="w-5"
              />
              <a
                href="mailto:kumarpiyush2909@gmail.com"
                className="hover:text-purple-600 dark:hover:text-purple-300 transition-colors"
              >
                kumarpiyush2909@gmail.com
              </a>
            </div>
          </div>
            ...
            <div className="flex gap-6">
              {socialLinks.map((link) => (
                <a
                  ...
                  className="text-gray-500 hover:text-purple-600 dark:hover:text-purple-300 transition-colors"
